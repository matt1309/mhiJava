...
/**
 * Tests for AirCon.RacParser protocol encoding and decoding.
 *
...
public class RacParserTest {
     ...
     * an AirCon.  This mirrors receiveToBytes() logic but is independent so
     * tests aren't circular.
     */
    private byte[] makeReceiveData(AirCon ac) {
