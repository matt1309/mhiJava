...
public class RacParser {
    ...
    public AirCon translateBytes(String inputString) {
       // AirCon acDevice = new AirCon();
        ...
        AirCon.this.setWindDirectionUD((content[2] & 192) == 64 ? 0 : findMatch(240 & content[3], 0, 16, 32, 48) + 1);
        AirCon.this.setWindDirectionLR((content[12] & 3) == 1 ? 0 : findMatch(31 & content[11], 0, 1, 2, 3, 4, 5, 6) + 1);
        ...
        AirCon.this.setErrorCode(code == 0 ? "00" : (content[6] & -128) <= 0 ? "M" + String.format("%02d", code) : "E" + code);
